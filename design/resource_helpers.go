...
func SliceForResourceName(name string, len, cap int) interface{} {
	rType := reflect.TypeOf(StructForResourceName(name))
	return reflect.MakeSlice(reflect.SliceOf(rType), len, cap).Interface()
}

func NewSliceForResourceName(name string, len, cap int) interface{} {
...
func SlicePlusForResourceName(name string, len, cap int) interface{} {
	rType := reflect.TypeOf(StructPlusForResourceName(name))
	return reflect.MakeSlice(reflect.SliceOf(rType), len, cap).Interface()
}

func NewSlicePlusForResourceName(name string, len, cap int) interface{} {
